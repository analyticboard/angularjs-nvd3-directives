...
//'xDomain', 'yDomain', 'xRange', 'yRange', ''clipEdge', 'clipVoronoi'
    ...
    //                                    .measures(attrs.measures === undefined ? function(d){ return d.measures; } : scope.measures())
        ...
        .directive('nvd3RadarChart', ['$filter', function($filter){
            return {
                restrict: 'EA',
                scope: {
                    data: '=',
                            ...
                            nv.addGraph({
                                generate: function(){
                                    ...
                                    var chart = nv.models.radarChart()
                                        ...
                                        .height(scope.height)
                                        .margin(scope.margin)
                                        .showLegend( attrs.showlegend === undefined ? true : attrs.showlegend === 'false' );
                                        //.noData(attrs.nodata === undefined ? 'No Data Available.' : scope.nodata)
                                        //.color(attrs.color === undefined ? nv.utils.defaultColor()  : scope.color());
        ...
        }]).directive( 'nvd3MultiBarRefChart', ['$filter', function ( $filter ) {
            return {
                restrict: 'EA',
                scope: {
                  data: '=',
